...
INTRADAY_SCAN_INTERVAL_SECONDS = get_int("INTRADAY_SCAN_INTERVAL_SECONDS", 120)
INTRADAY_SYMBOLS_PER_SCAN = get_int("INTRADAY_SYMBOLS_PER_SCAN", 100)
INTRADAY_PRIORITY_SYMBOLS_PER_SCAN = get_int("INTRADAY_PRIORITY_SYMBOLS_PER_SCAN", 50)
INTRADAY_BATCH_SIZE = get_int("INTRADAY_BATCH_SIZE", 20)


# ==============================
# PORTFOLIO
# ==============================
POSITION_LIMIT_MODE_FIXED_COUNT = "FIXED_COUNT"
POSITION_LIMIT_MODE_CAPITAL_BASED = "CAPITAL_BASED"
POSITION_LIMIT_MODE_ALLOWED = {POSITION_LIMIT_MODE_FIXED_COUNT, POSITION_LIMIT_MODE_CAPITAL_BASED}
POSITION_LIMIT_MODE = get_str("POSITION_LIMIT_MODE", POSITION_LIMIT_MODE_CAPITAL_BASED).upper()
if POSITION_LIMIT_MODE not in POSITION_LIMIT_MODE_ALLOWED:
    POSITION_LIMIT_MODE = POSITION_LIMIT_MODE_CAPITAL_BASED


def position_limit_mode() -> str:
    mode = str(globals().get("POSITION_LIMIT_MODE", POSITION_LIMIT_MODE_CAPITAL_BASED) or "").strip().upper()
    return mode if mode in POSITION_LIMIT_MODE_ALLOWED else POSITION_LIMIT_MODE_CAPITAL_BASED


def is_fixed_count_position_limit_mode() -> bool:
    return position_limit_mode() == POSITION_LIMIT_MODE_FIXED_COUNT


MAX_OPEN_POSITIONS = get_int("MAX_OPEN_POSITIONS", 10)
SWING_CAPITAL_PERCENT = get_float("SWING_CAPITAL_PERCENT", 50.0)
INTRADAY_CAPITAL_PERCENT = get_float("INTRADAY_CAPITAL_PERCENT", 40.0)
RESERVE_CAPITAL_PERCENT = get_float("RESERVE_CAPITAL_PERCENT", 10.0)

INTRADAY_FORCE_CLOSE_ENABLED = get_bool("INTRADAY_FORCE_CLOSE_ENABLED", True)
INTRADAY_FORCE_CLOSE_TIME = get_str("INTRADAY_FORCE_CLOSE_TIME", "15:50")
INTRADAY_MAX_HOLD_MINUTES = get_int("INTRADAY_MAX_HOLD_MINUTES", 360)

SWING_MAX_HOLD_DAYS = get_int("SWING_MAX_HOLD_DAYS", 20)

# ==============================
# TRADE QUALITY CLASSIFIER
# ==============================
TRADE_QUALITY_INTRADAY_MIN_SCORE = get_float("TRADE_QUALITY_INTRADAY_MIN_SCORE", 75.0)
TRADE_QUALITY_INTRADAY_MIN_RELATIVE_VOLUME = get_float("TRADE_QUALITY_INTRADAY_MIN_RELATIVE_VOLUME", 1.5)
TRADE_QUALITY_INTRADAY_MIN_DOLLAR_VOLUME = get_float("TRADE_QUALITY_INTRADAY_MIN_DOLLAR_VOLUME", 3_000_000.0)
TRADE_QUALITY_INTRADAY_MAX_SPREAD_PERCENT = get_float("TRADE_QUALITY_INTRADAY_MAX_SPREAD_PERCENT", 1.5)
TRADE_QUALITY_INTRADAY_MAX_SLIPPAGE_ESTIMATE = get_float("TRADE_QUALITY_INTRADAY_MAX_SLIPPAGE_ESTIMATE", 1.0)
TRADE_QUALITY_SWING_MIN_SCORE = get_float("TRADE_QUALITY_SWING_MIN_SCORE", 70.0)
TRADE_QUALITY_SWING_MIN_RELATIVE_VOLUME = get_float("TRADE_QUALITY_SWING_MIN_RELATIVE_VOLUME", 0.8)
TRADE_QUALITY_SWING_MIN_DOLLAR_VOLUME = get_float("TRADE_QUALITY_SWING_MIN_DOLLAR_VOLUME", 1_000_000.0)
TRADE_QUALITY_SWING_MAX_SPREAD_PERCENT = get_float("TRADE_QUALITY_SWING_MAX_SPREAD_PERCENT", 2.5)
TRADE_QUALITY_SWING_MAX_SLIPPAGE_ESTIMATE = get_float("TRADE_QUALITY_SWING_MAX_SLIPPAGE_ESTIMATE", 1.5)
TRADE_QUALITY_SWING_MAX_HOLD_DAYS = get_int("TRADE_QUALITY_SWING_MAX_HOLD_DAYS", SWING_MAX_HOLD_DAYS)
TRADE_QUALITY_MAX_DATA_AGE_SECONDS = get_float("TRADE_QUALITY_MAX_DATA_AGE_SECONDS", 300.0)
...
MAX_POSITION_PERCENT = get_float("MAX_POSITION_PERCENT", 10.0)
MIN_CASH_RESERVE_PERCENT = get_float("MIN_CASH_RESERVE_PERCENT", 10.0)
MIN_TRADE_USD = get_float("MIN_TRADE_USD", 50.0)
MIN_POSITION_SIZE_USD = get_float("MIN_POSITION_SIZE_USD", 500.0)
...
# ==============================
MAX_TOTAL_EXPOSURE_PERCENT = get_float("MAX_TOTAL_EXPOSURE_PERCENT", 90.0)
...
POSITION_TRACK_INTERVAL_SECONDS = get_int("POSITION_TRACK_INTERVAL_SECONDS", 45)
SWING_POSITION_TRACK_INTERVAL_SECONDS = get_int("SWING_POSITION_TRACK_INTERVAL_SECONDS", 60)
...
RENDER_API_URL = get_str("RENDER_API_URL", "https://stock-alert-system-moit.onrender.com").rstrip("/")
BROKER_PUSH_TOKEN = get_str("BROKER_PUSH_TOKEN", "change-me")
BROKER_SNAPSHOT_MAX_AGE_SECONDS = get_int("BROKER_SNAPSHOT_MAX_AGE_SECONDS", 60)
...
# WATCHDOG
# ==============================
WATCHDOG_INTERVAL_SECONDS = get_int("WATCHDOG_INTERVAL_SECONDS", 30)
WATCHDOG_TWS_MIRROR_STALE_SECONDS = get_int("WATCHDOG_TWS_MIRROR_STALE_SECONDS", 120)
WATCHDOG_EXECUTION_SYNC_STALE_SECONDS = get_int("WATCHDOG_EXECUTION_SYNC_STALE_SECONDS", 120)
WATCHDOG_MARKET_DATA_STALE_SECONDS = get_int("WATCHDOG_MARKET_DATA_STALE_SECONDS", 300)
WATCHDOG_POSITION_TRACKING_STALE_SECONDS = get_int("WATCHDOG_POSITION_TRACKING_STALE_SECONDS", max(60, POSITION_TRACK_INTERVAL_SECONDS * 4))
WATCHDOG_DISCONNECT_CIRCUIT_SECONDS = get_int("WATCHDOG_DISCONNECT_CIRCUIT_SECONDS", 180)
WATCHDOG_RECONNECT_BACKOFF_SECONDS = get_int("WATCHDOG_RECONNECT_BACKOFF_SECONDS", 30)
WATCHDOG_ALERT_COOLDOWN_SECONDS = get_int("WATCHDOG_ALERT_COOLDOWN_SECONDS", 300)
...
INTRADAY_MIN_RELATIVE_VOLUME = get_float("INTRADAY_MIN_RELATIVE_VOLUME", 1.0)
INTRADAY_MIN_DOLLAR_VOLUME = get_float("INTRADAY_MIN_DOLLAR_VOLUME", 2_000_000.0)
INTRADAY_MIN_AVERAGE_VOLUME = get_float("INTRADAY_MIN_AVERAGE_VOLUME", 300_000.0)
SWING_MIN_SCORE_TO_BUY = get_int("SWING_MIN_SCORE_TO_BUY", 65)
SWING_MIN_AVERAGE_VOLUME = get_float("SWING_MIN_AVERAGE_VOLUME", 500_000.0)
SWING_MIN_DOLLAR_VOLUME = get_float("SWING_MIN_DOLLAR_VOLUME", 5_000_000.0)
INTRADAY_MAX_SPREAD_PERCENT = get_float("INTRADAY_MAX_SPREAD_PERCENT", MAX_SPREAD_PERCENT)
INTRADAY_MAX_SLIPPAGE_ESTIMATE = get_float("INTRADAY_MAX_SLIPPAGE_ESTIMATE", MAX_SLIPPAGE_ESTIMATE)
INTRADAY_MAX_DAILY_TRADES = get_int("INTRADAY_MAX_DAILY_TRADES", 5)
INTRADAY_MAX_CONSECUTIVE_LOSSES = get_int("INTRADAY_MAX_CONSECUTIVE_LOSSES", 2)
INTRADAY_MAX_DAILY_LOSS_PERCENT = get_float("INTRADAY_MAX_DAILY_LOSS_PERCENT", 2.0)
INTRADAY_FORCE_EXIT_MINUTES_BEFORE_CLOSE = get_int("INTRADAY_FORCE_EXIT_MINUTES_BEFORE_CLOSE", 15)
