...
POSITION_TRACK_INTERVAL_SECONDS = get_int("POSITION_TRACK_INTERVAL_SECONDS", 15)
...
INTRADAY_MIN_RELATIVE_VOLUME = get_float("INTRADAY_MIN_RELATIVE_VOLUME", 1.5)
INTRADAY_MIN_DOLLAR_VOLUME = get_float("INTRADAY_MIN_DOLLAR_VOLUME", MIN_DOLLAR_VOLUME)
