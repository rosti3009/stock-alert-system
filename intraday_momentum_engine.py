...
def build_dashboard_payload(row: dict[str, Any], position: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "aggressive_score": entry["intraday_aggressive_score"],
        "intraday_aggressive_score": entry["intraday_aggressive_score"],
        "aggressive_entry_allowed": entry["aggressive_entry_allowed"],
        "aggressive_rejection_reasons": entry["aggressive_rejection_reasons"],
        "active_profile": entry["active_profile"],
        "breakout_strength_score": entry["breakout_strength_score"],
        "momentum_acceleration_score": entry["momentum_acceleration_score"],
        "vwap_reclaim_signal": entry["vwap_reclaim_signal"],
        "volatility_expansion_signal": entry["volatility_expansion_signal"],
        "regime_override_active": entry["regime_override_active"],
        "regime_override_reason": entry["regime_override_reason"],
        "market_regime_before_override": entry["market_regime_before_override"],
        "market_regime_after_override": entry["market_regime_after_override"],
        "regime_override": entry["regime_override"],
